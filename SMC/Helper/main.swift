...
class Helper: NSObject, NSXPCListenerDelegate, HelperProtocol {
    ...
    private let smcQueue = DispatchQueue(label: "com.sagar.perch.SMC.Helper.smcQueue")
    ...
    override init() {
        self.listener = NSXPCListener(machServiceName: "com.sagar.perch.SMC.Helper")
        super.init()
    ...
    private func uninstallHelper() {
        ...
        process.arguments = ["unload", "/Library/LaunchDaemons/com.sagar.perch.SMC.Helper.plist"]
        do {
            try process.run()
        ...
        do {
            try FileManager.default.removeItem(at: URL(fileURLWithPath: "/Library/LaunchDaemons/com.sagar.perch.SMC.Helper.plist"))
        } catch let err {
        ...
        do {
            try FileManager.default.removeItem(at: URL(fileURLWithPath: "/Library/PrivilegedHelperTools/com.sagar.perch.SMC.Helper"))
        } catch let err {
...
extension Helper {
    ...
    func uninstall() {
        let process = Process()
        process.executableURL = URL(fileURLWithPath: "/Library/PrivilegedHelperTools/com.sagar.perch.SMC.Helper")
        process.qualityOfService = QualityOfService.userInitiated
