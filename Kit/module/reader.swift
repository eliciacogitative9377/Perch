...
open class Reader<T: Codable>: NSObject, ReaderInternal_p {
    ...
    private let valueQueue = DispatchQueue(label: "com.sagar.perch.readerActiveQueue")
    ...
    private let activeQueue = DispatchQueue(label: "com.sagar.perch.readerActiveQueue")
    ...
    private let alignQueue = DispatchQueue(label: "com.sagar.perch.readerAlignQueue")
