...
class i18n:
    path = os.getcwd() + "/Perch/Supporting Files"

    app_context = (
        "Context: the text is a short UI label from Perch, an open-source macOS menu-bar "
    ...
    def __init__(self):
        if "Kit/scripts" in os.getcwd():
            self.path = os.getcwd() + "/../../Perch/Supporting Files"
    ...
    def scan(self, clean=False, accept=False):
        ...
        code_dirs = ["Perch", "Kit", "Modules", "Widgets", "SMC", "LaunchAtLogin"]
