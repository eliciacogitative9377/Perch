...
private class HeroView: NSView {
    ...
    public init() {
        ...
        let title = NSTextField(labelWithString: "System Perch")
        title.font = NSFont.systemFont(ofSize: 22, weight: .semibold)
        title.alignment = .center
        
        let subtitleText = localizedString("Monitor and control your Macs from anywhere. Sign in to your System Perch account to see all your devices and hosts in one place.")
