...
internal class FanView: NSStackView {
    ...
    private func showApprovalPending() {
        ...
        alert.informativeText = localizedString("To control the fans, enable Perch in System Settings ▸ Login Items.")
    ...
    private func showInstallFailed() {
        ...
        alert.informativeText = localizedString("Open System Settings ▸ Login Items, make sure Perch is allowed in the background, then try again.")
        alert.addButton(withTitle: localizedString("Open Login Items"))
        alert.addButton(withTitle: localizedString("Cancel"))
