...
public class Portal: PortalWrapper {
    ...
    private var appColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_appColor", defaultValue: SColor.chartBlue.key)).additional as! NSColor
    }
    private var wiredColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_wiredColor", defaultValue: SColor.chartMagenta.key)).additional as! NSColor
    }
    private var compressedColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_compressedColor", defaultValue: SColor.chartOlive.key)).additional as! NSColor
    }
