...
public struct Clock_t: Codable {
    ...
    private static let formattersQueue = DispatchQueue(label: "com.sagar.perch.Clock.formatters")
...
public class Clock: Module {
    ...
    private static let listQueue = DispatchQueue(label: "com.sagar.perch.Clock.list")
