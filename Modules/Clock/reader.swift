...
internal class ClockReader: Reader<Date> {
    ...
    private let queue = DispatchQueue(label: "com.sagar.perch.Clock.ntp.sync", qos: .default)
    private let requestQueue = DispatchQueue(label: "com.sagar.perch.Clock.ntp.request", qos: .utility)
