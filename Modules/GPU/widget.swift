...
public struct Provider: TimelineProvider {
    ...
    private let userDefaults: UserDefaults? = UserDefaults(suiteName: "\(Bundle.main.object(forInfoDictionaryKey: "TeamId") as! String).com.sagar.perch.widgets")
...
public struct GPUWidget: Widget {
    var usedColor: Color = Color(nsColor: NSColor.perchAccent)
