...
private class UpdateView: NSView {
    ...
    internal func noUpdates() {
        ...
        title.stringValue = localizedString("The latest version of Perch installed")
    ...
    @objc private func changelog() {
        if let version = self.version, let url = Branding.releaseNotesURL(version.latest) {
    ...
    @objc private func install() {
        ...
        state.alignment = .center
        state.textColor = .secondaryLabelColor
        state.stringValue = localizedString("Perch will restart automatically")
